    ...
    >
      ...
      {links.map((link, index) => {
        ...
        <div className='link-content'>
          ...
          <button className='add-link-button' onClick={() => setShowInput(true)}>
            + Add new link
          </button>
          ...
          {links.map((link, index) => (
            <div className='link-item' key={index}>
              ...
              <input className='link-input' type='text' value={link.url} readOnly />
              <button className='remove-link-button' onClick={() => removeLink(index)}>
                Remove
              </button>
            </div>
          ))}
